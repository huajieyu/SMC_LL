...
def server_create_command_services():
    pydim.dis_add_cmnd('int_cmnd',"C",dummy,1)
    print('Added command int_cmnd with DIM format C')
...
def main():
    ...
    dns_node = pydim.dis_get_dns_node("server-name")
    print(dns_node)

    dns_port = pydim.dis_get_dns_port()
    print(dns_port)
